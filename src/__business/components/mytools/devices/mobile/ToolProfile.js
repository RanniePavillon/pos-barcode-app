                    ...
                    {tp.stat && (
                        <Box height="100%" width="100%" display="flex" flexDirection="column" pt="20px" pb="16px" gap="20px">
                            ...
                            <Box minHeight="36px" width="100%" display="flex" justifyContent='center' alignItems="center" px={xsm ? '8px' : '16px'}>
                                ...
                                :
                                    <Box sx={{width:'100%', height:'36px', borderRadius:'6px', display:'flex', alignItems:'center', justifyContent:'center'}} bgcolor="#E3ECEA" color="#107038" fontSize={14} fontWeight={500} lineHeight="24px">
                                        <Box>Coming Soon</Box>
                                    </Box>
                                }
                            </Box>
